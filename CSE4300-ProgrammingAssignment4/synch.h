...
struct lock {
	...
	char *name;
	volatile int lock_acquired; //This will be 0 if the lock isn't taken, and 1 if it is taken.
	volatile struct thread *lock_acquire; //This thread is when a lock is being held by a thread.
